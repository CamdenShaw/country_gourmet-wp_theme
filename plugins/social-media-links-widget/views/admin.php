...
<div class="widget-content">
    ...
    <p><label for="<?php echo $this->get_field_id( 'tumblr' ); ?>">Tumblr:</label>
    ...
    <p><label for="<?php echo $this->get_field_id( 'googleplus' ); ?>">Google Plus:</label>
    ...
    <p><label for="<?php echo $this->get_field_id( 'flickr' ); ?>">Flickr:</label>
